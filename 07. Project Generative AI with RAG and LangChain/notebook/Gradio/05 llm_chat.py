...
def generate_response(prompt_txt):
    text = f"You are a AI bot built to answer questions. Always answer to the point for question : {prompt_txt}".format(prompt_txt) 
    generated_response = watsonx_llm.invoke(text)
